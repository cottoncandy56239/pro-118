$(document).ready(function(){
    ...
    $('#current_date').text('Date : ' + current_date)
    ...
    $('#smartphone_button').click(function(){

        review = $('#smartphone_textbox').val()
    ...
    $('#videogame_button').click(function(){

        review = $('#videogame_textbox').val()
        input_data = {'customer_review' : review}
        ajax_request('/predict' , input_data)
